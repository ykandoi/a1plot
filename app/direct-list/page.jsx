...
export const metadata = {
  ...
  // Same content as /list_property — canonicalize so search engines
  // consolidate ranking signals onto the primary page instead of splitting
  // them across duplicate ad-landing variants.
