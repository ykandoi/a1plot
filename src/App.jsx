          ...
          <div className="form-group mb-8">
            ...
            {isLoaded ? (
              <>
                ...
                {isDrawingMode && (
                  <div style={{ marginTop: '0.5rem', fontSize: '0.85rem', color: '#1e293b', fontWeight: 500, textAlign: 'center', background: '#f8fafc', padding: '0.5rem', borderRadius: '0.5rem', border: '1px solid #e2e8f0' }}>
